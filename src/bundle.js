...
function check() {
  var distt = dist();
  var temp = parseInt(distt)+ parseInt(pr)

  var vall= ((distt)/(cr) )*100;
...
var score = 0;
var i = 0;
timer = setInterval(circlespawn, 3000);
timer1 = setInterval(Game, 20);
...
function Game(timestamp) {
  ...
  // //output
  // ctx.clearRect(width - 200, 0, width, 30);
  // ctx.fillText("px py pr " + px + " " + py+ " "+ pr, width - 200, 10, 200);
